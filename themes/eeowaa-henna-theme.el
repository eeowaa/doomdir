...
(defcustom eeowaa-henna-brighter-comments nil
...
(def-doom-theme eeowaa-henna
  ...
  ((bg         '("#21272e" nil       nil            ))
   ...
   (-modeline-bright eeowaa-henna-brighter-modeline)
   (-modeline-pad
    (when eeowaa-henna-padded-modeline
      (if (integerp eeowaa-henna-padded-modeline) eeowaa-henna-padded-modeline 4)))
