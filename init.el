...
(doom! :input
       ...
       ;; PREREQ echo 'set startup-with-shell off' >> ~/.gdbinit
       ...
       ;; PREREQ brew install go golangci-lint
       ;; PREREQ echo 'export GOPATH=$HOME/src/go' >> ~/.zshrc
       ;; PREREQ echo 'export PATH=$PATH:$GOPATH/bin' >> ~/.zshrc
       ...
       ;; PREREQ brew install typescript npm
