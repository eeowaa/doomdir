...
ispell-init-process: Error: /Users/gouldsam/.config/emacs/.local/etc/ispell/english.pws: The language "english" is not known. This is probably because: the file "/usr/local/Cellar/aspell/0.60.8/lib/aspell-0.60/english.dat" can not be opened for reading.
#+end_quote
...
*** HOLD Ask on Discord
* Org [5/12]
** TODO [#A] Display distinguishable name in refile targets
...
** TODO [#B] Display parent directory instead of "todo.org" for Org agenda
